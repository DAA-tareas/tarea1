...
public class Ordenador {
    ...
    public static void printNodos(List<AbstractNodo> lista){
    ...
    public static List<AbstractNodo> ordenarSec(List<AbstractNodo> listaNodos, String fld){
    ...
    public static void main(String[] args) {
        AbstractNodo nodo = new NodoProd(4,1002, 2003, 2001 );
        AbstractNodo nodo2 = new NodoProd(2,1003, 2001, 2004 );
        AbstractNodo nodo3 = new NodoProd(3,1001, 2004, 2002 );
        AbstractNodo nodo4 = new NodoProd(1,1004, 2002, 2003 );
        List<AbstractNodo> lista = new ArrayList<>();
        lista.add(nodo);
        lista.add(nodo2);
        lista.add(nodo3);
        lista.add(nodo4);
